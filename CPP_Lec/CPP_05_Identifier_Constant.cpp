...
Identifiers : are the name of variables, functions, etc.

int is a keyword so it cannot be a identifier
long is a keyword so it cannot be a identifier
switch is a keyword so it cannot be a identifier
